<?php
/*
Plugin Name: Update Post with EXIF data (UNMAINTAINED)
Plugin URI: https://wordpress.org/plugins/update-post-with-exif-data/
Description: THIS PLUGIN IS NO LONGER MAINTAINED. Reads in EXIF data of post thumbnail; adds tags to the post and a custom meta value containing the calculated GPS location of the image, if the appropriate checkbox is selected in the Post submit box.
